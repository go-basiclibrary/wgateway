...
import (
	...
	"syscall"
	"time"
	"wgateway/demo/proxy/reverse_proxy_https/testdata"
)
...
//CA数据证书
openssl req -x509 -new -nodes -key ca.key -subj "/C=CN/O=MyOrg/OU=MyUnit/CN=example1.com" -days 5000 -out ca.crt
